...
public class Vision extends SubsystemBase {
  ...
  LoggedNetworkNumber ambiguity =
      new LoggedNetworkNumber("Vision/Tuning/Ambiguity", VisionConstants.MAX_AMBIGUITY);
  LoggedNetworkNumber zError =
      new LoggedNetworkNumber("Vision/Tuning/zError", VisionConstants.MAX_Z_ERROR);
        ...
        boolean rejectPose =
            observation.tagCount() == 0 // Must have at least one tag
                ...
                || Math.abs(observation.pose().getZ())
                    > zError.get() // Must have realistic Z coordinate
